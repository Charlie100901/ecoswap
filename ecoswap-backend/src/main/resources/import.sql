...
INSERT INTO products(category, condition_product ,description, product_status, title, user_id, release_date, image_product) VALUES ('tecnologia','nuevo' , 'pc gamer', 'activo', 'pc gamer', 1, '2024-05-05', 'http://localhost:8001/images/pc-gamer.jpeg' );
INSERT INTO products(category, condition_product ,description, product_status, title, user_id, release_date, image_product) VALUES ('hogar', 'usado' ,'nochero', 'activo', 'nochero', 2, '2024-05-05', 'http://localhost:8001/images/nochero.jpg');
INSERT INTO products(category, condition_product ,description, product_status, title, user_id, release_date, image_product) VALUES ('tecnologia','usado' , 'monitor', 'activo', 'monitor', 3, '2024-05-05', 'http://localhost:8001/images/monitor.jpg');
INSERT INTO products(category, condition_product ,description, product_status, title, user_id, release_date, image_product) VALUES ('hogar', 'usado' ,'mesa', 'activo', 'mesa', 4, '2024-05-05', 'http://localhost:8001/images/mesa-gamer.jpg');
